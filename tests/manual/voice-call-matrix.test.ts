...
const SCENARIOS: Scenario[] = [
  ...
  { name: 'known caller reschedules #471', caller: KNOWN, script: ['I need to move my appointment on the 8th', 'monday same time if you can', "no that's it", 'no', 'thanks bye'], expect: { mustSay: [/vanildo/i, /monday/i], mustCall: ['check_availability', 'reschedule_appointment'], mustNotCall: ['book_appointment', 'lookup_customer'] } },
